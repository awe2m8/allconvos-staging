...
export function AuthSessionIndicator() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[70]">
      <SignedOut>
        <div className="rounded-xl border border-white/15 bg-ocean-950/90 px-4 py-3 shadow-2xl backdrop-blur-md">
          ...
          <Link
            href={loginUrl}
            className="mt-2 inline-flex items-center justify-center rounded-lg border border-neon/40 px-3 py-1.5 text-[11px] font-mono uppercase tracking-widest text-neon hover:bg-neon/10"
          >
            Member Login
          </Link>
        </div>
